...
export class ProductionCollectionJobRunner {
  ...
  public constructor(readonly repository:FileDurableJobRepository,private readonly collections:ProductionCollectionSurface,private readonly now:()=>Date=()=>new Date()){}
